...
from src.simulator.viewers.proximity_sensor_view import ProximitySensorView
from src.simulator.viewers.supervisor_view import SupervisorView
...
class RobotView:
    ...
    def draw_robot_to_frame(self):
        ...
        position = self.robot.state.pose.vposition()
    ...
    def _draw_traverse_path_to_frame(self):
        self.viewer.current_frame.add_lines(
            [self.traverse_path], color="black", linewidth=0.01
        )
