...
from src.simulator.models.sensor import Sensor
from src.simulator.models.line_segment import LineSegment
...
class ProximitySensor(Sensor):
    ...
    def _update_pose(self):
        self.pose = self.placement_pose.transform_to(self.robot.state.pose)
